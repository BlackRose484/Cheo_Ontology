      ...
      <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden cursor-pointer group h-full flex flex-col border border-red-100 hover:border-red-300">
        ...
        <div className="aspect-video w-full bg-gradient-to-br from-red-100 to-yellow-100 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-red-100 to-yellow-100 flex items-center justify-center">
            ...
            />
            <div className="text-red-500 text-5xl relative z-10">🎭</div>
          </div>

          {/* Play button overlay */}
          <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 flex items-center justify-center transition-all duration-300">
            <div className="bg-gradient-to-r from-red-500 to-yellow-500 bg-opacity-0 group-hover:bg-opacity-90 rounded-full p-0 group-hover:p-3 transition-all duration-300 shadow-lg">
              <svg
          ...
          {/* Duration badge */}
          {item.duration && (
            <div className="absolute bottom-2 right-2 bg-gradient-to-r from-red-600 to-red-700 text-white text-xs px-2 py-1 rounded shadow-md">
              {item.duration}
            </div>
          )}

          {/* Vietnamese flag corner decoration */}
          <div className="absolute top-0 left-0 w-8 h-8 bg-gradient-to-br from-red-500 to-yellow-500 opacity-60 rounded-br-full"></div>
        ...
        <div className="p-4 flex-1 flex flex-col">
          <h3 className="font-semibold text-gray-900 text-sm line-clamp-2 mb-2 group-hover:text-red-600 transition-colors min-h-[2.5rem]">
